...
urlpatterns = [
    ...
    url(r'^veicolo/manutenzione/(?P<manutenzione>.*)/elimina/$', veicoli.viste.veicoli_elimina_manutenzione),
    url(r'^veicolo/rifornimento/(?P<rifornimento>.*)/elimina/$', veicoli.viste.veicoli_elimina_rifornimento),
