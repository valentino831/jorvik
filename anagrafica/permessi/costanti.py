...
PERMESSI_OGGETTI = (
    ...
    (RUBRICA_DELEGATI_AREA,     ('anagrafica', 'Sede')),
    ...
    (RUBRICA_RESPONSABILI_AREA,     ('anagrafica', 'Sede')),
    (RUBRICA_REFERENTI_ATTIVITA,    ('anagrafica', 'Sede')),
    ...
    (RUBRICA_DIRETTORI_CORSI,       ('anagrafica', 'Sede')),
