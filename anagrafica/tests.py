...
from anagrafica.models import Appartenenza, Documento, Delega, Dimissione, Estensione, Trasferimento
...
class TestAnagrafica(TestCase):
    ...
    def test_rubriche_delegati(self):
        ...
        elenco = _rubrica_delegati(delegato_territorio_empoli, DELEGATO_OBIETTIVO_3)[0].risultati()
        self.assertEqual(0, len(elenco))
        self.assertNotIn(delegato_nazionale, elenco)
        self.assertNotIn(delegato_toscana, elenco)
        self.assertNotIn(delegato_firenze, elenco)
...
class TestFunzionaliAnagrafica(TestFunzionale):
    ...
    def test_rubriche_delegati(self):
        ...
        sessione_delegato_firenze = self.sessione_utente(utente=utenza)
        ...
        sessione_delegato_abruzzo = self.sessione_utente(utente=utenza)
