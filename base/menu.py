    ...
    return remove_none({
        "utente": (
            ...
            ("Rubrica", (
                ...
                ("Delegati Obiettivo IV (Principi)", "fa-book", "/utente/rubrica/delegati_obiettivo_4/") if ha_deleghe and delega_obiettivo_4 else None,
                ("Delegati Obiettivo VI (Sviluppo)", "fa-book", "/utente/rubrica/delegati_obiettivo_6/") if ha_deleghe and delega_obiettivo_6 else None,
